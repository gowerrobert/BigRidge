...
$\dsp \lambda_{min}(A^{-\frac12}E\croc{Z|D}A^{-\frac12} ) \geq \dsp  \frac{\lambda_{min}(A) \lambda_{min}(\bold{C}_{D} \bold{C}_{D}^{T})}{ n! \, \lambda_{max}(A) \lambda_{max}(f_{\pi}^{T} f_{\pi})}. $\\
 ...
 \baStar
 \bold{C}_{D} \bold{C}_{D}^{T} &=& \dsp\sum\limits_{k=1}^{n!}\\
 &=& \small  (n-1)!\left(
    \begin{array}{ccccc}
    \tr(D f_{\pi}^{T} f_{\pi} D)                                    \\
      & \tr(D f_{\pi}^{T} f_{\pi} D)               &   & \textbf{\Large $\frac{\tr\pare{D f_{\pi}^{T} f_{\pi} D (J-I_{n}) }}{n-2}$  }\\
      &               & \ddots               \\
      &\textbf{\Large $\frac{\tr\pare{D f_{\pi}^{T} f_{\pi} D (J-I_{n}) }}{n-2}$  }&   & \tr(D f_{\pi}^{T} f_{\pi} D)               \\
      &               &   &   & \tr(D f_{\pi}^{T} f_{\pi} D)   
    \end{array}
    \right).\\
    \eaStar
