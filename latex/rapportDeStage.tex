...
$A^{-\frac12}E[Z]A^{-\frac12} = (A^{\frac 12} \bold{C} D)(D \bold{C}^{T} A^{\frac 12})$.\\

And then :\\
$\lambda_{min}(A^{-\frac12}E[Z]A^{-\frac12} ) \geq \lambda_{min}(\bold{C}^{T}A\bold{C} ) \lambda_{min}(D^{2}) $ where $D = \sqrt{p} \text{diag}( (S_{1}AS_{1}^{T})^{-\frac 12},\dots, (S_{r}AS_{r}^{T})^{-\frac 12})$
